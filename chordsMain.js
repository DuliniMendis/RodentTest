...
//var neuronn =  JSON.parse('neuron_names.json');
//console.log('Starting directory: ' + process.cwd());

/*var neuron_names;
$.getJSON('neuron_names.json' function(json) {
  var neuron_names = json;
});*/
//var neuron_names = jQuery.getJSON('neuron_names.json')
//, function(error, neuron_names){
//    console.log(neuron_names);
    //use data here
//})

d3.json("https://github.com/russellijarvis/3Drodent/blob/elaborate_modfile/web/inhibitory_network.json", function(error, data){
    console.log(data);

})

d3.json("https://github.com/russellijarvis/3Drodent/blob/elaborate_modfile/web/excitatory_network.json", function(error, data){
    console.log(data);

})

//var NameProvider = NeuronLabels

//var matrix //read in from json file.  
//var matrixin =  d3.json("inhibitory_network.json");
///var matrixex =  d3.json("excitatory_network.json");

//console.log(matrixin);
//console.log(matrixex);
...
[1.1628,2.6024,0,1.3843,8.7486,16.8328,1.7165,5.5925], //amsung 38.0399
